...
if [ "$1" = "i686" ]; then
  ...
  curl https://skytemple.org/build_deps/win32/skytemple_rust-1.4.0-cp310-cp310-mingw_i686.whl -O
  ...
  curl https://skytemple.org/build_deps/skytemple_rust-1.4.0-cp310-cp310-mingw_x86_64.whl -O
