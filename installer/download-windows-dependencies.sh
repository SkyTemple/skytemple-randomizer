#!/bin/sh
if [ "$1" = "i686" ]; then
  curl https://skytemple.org/build_deps/win32/tilequant-0.4.1-cp310-cp310-mingw_i686.whl -O
  ...
  curl https://skytemple.org/build_deps/tilequant-0.4.1-cp310-cp310-mingw_x86_64.whl -O
